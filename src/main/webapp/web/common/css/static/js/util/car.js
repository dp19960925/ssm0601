				...
				function(exports) {
					...
					var car = {
							...
							function getSubTotal(ul) {
								...
								var Total = parseFloat(unitprice * count);
								var id = ul.getElementsByClassName('Quantity-input')[0]
										.getAttribute('name');
								//alert(id)
								ul.getElementsByClassName('sum')[0].innerHTML = Total.toFixed(2);
